...
export default function Home() {
  ...
  return (
        ...
        {/* Darker Red to White Gradient Top Section */}
        <div className="absolute top-0 left-0 right-0 h-2/5 bg-gradient-to-b from-red-300 via-red-200 to-white"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
                ...
                <div className="w-16 h-16 bg-gradient-to-b from-red-300 via-red-200 to-white rounded-lg flex items-center justify-center relative overflow-hidden">
                  <img 
                    src="/cartoon-avatar.png" 
                    alt="Cartoon character with glasses, book, and pencil" 
                    className="w-full h-full object-contain"
                  />
                </div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-red-700 bg-clip-text text-transparent">Test Buddy</h1>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {!planLoading && (
                <UserDropdown
                  ...
                  onUpgrade={() => showUpgradePrompt('general')}
                  onPlanManager={() => setShowPlanManager(true)}
                  canAccessFolders={planFeatures.folders}
                  canAccessMetrics={Boolean(planFeatures.metrics)}
                  showUpgradeOption={plan === 'free' || plan === 'student'}
                />
              )}
            </div>
          </div>
                  ...
                  <button
                    ...
                    className={`w-full px-6 py-3 rounded-lg font-medium transition-colors ${
                      canCreateTest
                        ...
                        : 'bg-gradient-to-r from-gray-800 to-red-700 text-white hover:from-gray-900 hover:to-red-800'
                    }`}
                  >
        ...
        {appState === 'upload' && (
          <div className="max-w-2xl mx-auto px-6">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-red-700 bg-clip-text text-transparent mb-4">
                Create Your Quiz
              </h2>
        ...
        {appState === 'config' && uploadedFile && (
          <div className="max-w-2xl mx-auto px-6">
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-red-700 bg-clip-text text-transparent mb-2">
                Configure Your Quiz
              </h2>
